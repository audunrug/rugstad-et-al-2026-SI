...
We see that some of the iterations produce warnings from the `L-BFGS-B` optimiser. However, (explain

(Write an e-mail to Jenni about the optimizer settings that aren't carried over to the R side)
